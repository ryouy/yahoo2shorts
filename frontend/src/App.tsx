...
export default function App() {
  ...
  return <Shell page={route.page} onNavigate={page => navigate(page)}>
    ...
    {route.page === 'project' && route.projectId && <ProjectWorkspace projectId={route.projectId} initialJob={initialJob} onBack={() => { loadProjects(); navigate('dashboard') }} onError={text => notify('error', text)} onNotice={text => notify('notice', text)} />}
